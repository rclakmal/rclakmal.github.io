...
function drawFirstYoda() {
    ...
    callChart = Morris.Line({
        ...
        data : basicYodadata,
        xkey : 'period',
        ykeys : [ 'HandledCallVolume', 'YodacastPredicatedVolume' ],
        labels : [ 'HandledCallVolume', 'YodacastPredicatedVolume' ],
        pointSize : 2,
        parseTime : false,
        hideHover : 'auto',
        resize : true,
...
function drawWeatherYoda() {
    ...
    callChart = Morris.Line({
        ...
        xkey : 'period',
        ykeys : [ 'YodacastPredicatedVolume', 'BadWeather', 'GoodWeather' ],
        labels : [ 'YodacastPredicatedVolume', 'BadWeather', 'GoodWeather' ],
        pointSize : 2,
        parseTime : false,
        hideHover : 'auto',
        resize : true,
...
function drawFootBallYoda() {
    ...
    callChart = Morris.Line({
        ...
        data : footBallData,
        xkey : 'period',
        ykeys : [ 'YodacastPredicatedVolume', 'Football' ],
        labels : [ 'YodacastPredicatedVolume', 'Football' ],
        pointSize : 2,
        parseTime : false,
        hideHover : 'auto',
        resize : true,
